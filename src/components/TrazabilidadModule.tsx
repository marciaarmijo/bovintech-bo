...
import { ArrowLeft, Plus, Search, Filter, MapPin, Calendar, Truck } from 'lucide-react';
        ...
        <div className="grid grid-cols-3 gap-3">
          <Card className="card-shadow bg-white">
            <CardContent className="p-4 text-center">
              <div className="text-2xl font-bold text-[#3a210c]">247</div>
          ...
          <Card className="card-shadow bg-white">
            <CardContent className="p-4 text-center">
              <div className="text-2xl font-bold text-[#3a210c]">12</div>
        ...
        <div>
          ...
          <div className="space-y-3">
            {filteredAnimals.map(animal => (
              <Card key={animal.id} className="border border-[#ac815d] bg-white">
            ...
            <div className="p-4 space-y-4">
              ...
              <div>
                ...
                <select className="w-full mt-1 p-2 border border-gray-300 rounded-md">
                  <option>Potrero Norte</option>
                  <option>Potrero Sur</option>
                  <option>Potrero Este</option>
                  <option>Corral Central</option>
                </select>
              </div>
              ...
              <div>
                ...
                <select className="w-full mt-1 p-2 border border-gray-300 rounded-md">
                  <option>Rotación de pastoreo</option>
                  <option>Tratamiento médico</option>
                  <option>Revisión veterinaria</option>
                  <option>Separación por edad</option>
                  <option>Otro</option>
                </select>
              </div>
